...
#' @param loadings_g Loadings' magnitude on the general factors: "low", "medium" or "high".
#' @param loadings_s Loadings' magnitude on the group factors: "low", "medium" or "high".
...
#' @param generals_rho Correlation among the general factors.
#' @param groups_rho Correlation among the group factors.
#'
