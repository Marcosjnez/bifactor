...
rotate <- function(loadings, rotation = as.character( c("oblimin")), projection = "oblq", gamma = 0, epsilon = 0.01, k = 0, w = 1, alpha = 1, Target = NULL, Weight = NULL, PhiTarget = NULL, PhiWeight = NULL, blocks = NULL, blocks_list = NULL, block_weights = NULL, oblq_blocks = NULL, penalization = "none", rot_control = NULL, random_starts = 1L, cores = 1L) {
...
efast <- function(R, n_factors, method = "minres", rotation = as.character( c("oblimin")), projection = "oblq", Target = NULL, Weight = NULL, PhiTarget = NULL, PhiWeight = NULL, blocks = NULL, blocks_list = NULL, block_weights = NULL, oblq_blocks = NULL, normalize = FALSE, penalization = "none", gamma = 0, epsilon = 0.01, k = 0, w = 1, alpha = 1, random_starts = 1L, cores = 1L, init = NULL, efa_control = NULL, rot_control = NULL) {
...
se <- function(n, fit = NULL, R = NULL, Lambda = NULL, Phi = NULL, X = NULL, method = "minres", projection = "oblq", rotation = as.character( c("oblimin")), Target = NULL, Weight = NULL, PhiTarget = NULL, PhiWeight = NULL, blocks = NULL, blocks_list = NULL, block_weights = NULL, oblq_blocks = NULL, gamma = 0, k = 0, epsilon = 0.01, w = 1, alpha = 1, normalize = FALSE, penalization = "none", type = "normal", eta = 1) {
