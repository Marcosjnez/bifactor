...
// multiple_rotations
Rcpp::List multiple_rotations(arma::mat loadings, std::string rotation, arma::mat Target, arma::mat Weight, arma::mat Phi_Target, arma::mat Phi_Weight, double gamma, double epsilon, double k, double w, int random_starts, int cores, double eps, int max_iter);
RcppExport SEXP _bifactor_multiple_rotations(SEXP loadingsSEXP, SEXP rotationSEXP, SEXP TargetSEXP, SEXP WeightSEXP, SEXP Phi_TargetSEXP, SEXP Phi_WeightSEXP, SEXP gammaSEXP, SEXP epsilonSEXP, SEXP kSEXP, SEXP wSEXP, SEXP random_startsSEXP, SEXP coresSEXP, SEXP epsSEXP, SEXP max_iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(multiple_rotations(loadings, rotation, Target, Weight, Phi_Target, Phi_Weight, gamma, epsilon, k, w, random_starts, cores, eps, max_iter));
    return rcpp_result_gen;
END_RCPP
}
// efast
Rcpp::List efast(arma::mat R, int n_factors, std::string method, std::string rotation, Rcpp::Nullable<Rcpp::NumericVector> init, Rcpp::Nullable<Rcpp::NumericMatrix> Target, Rcpp::Nullable<Rcpp::NumericMatrix> Weight, Rcpp::Nullable<Rcpp::NumericMatrix> PhiTarget, Rcpp::Nullable<Rcpp::NumericMatrix> PhiWeight, bool normalize, double gamma, double epsilon, double k, double w, int random_starts, int cores, int efa_max_iter, double efa_factr, int m, int rot_max_iter, double rot_eps);
RcppExport SEXP _bifactor_efast(SEXP RSEXP, SEXP n_factorsSEXP, SEXP methodSEXP, SEXP rotationSEXP, SEXP initSEXP, SEXP TargetSEXP, SEXP WeightSEXP, SEXP PhiTargetSEXP, SEXP PhiWeightSEXP, SEXP normalizeSEXP, SEXP gammaSEXP, SEXP epsilonSEXP, SEXP kSEXP, SEXP wSEXP, SEXP random_startsSEXP, SEXP coresSEXP, SEXP efa_max_iterSEXP, SEXP efa_factrSEXP, SEXP mSEXP, SEXP rot_max_iterSEXP, SEXP rot_epsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(efast(R, n_factors, method, rotation, init, Target, Weight, PhiTarget, PhiWeight, normalize, gamma, epsilon, k, w, random_starts, cores, efa_max_iter, efa_factr, m, rot_max_iter, rot_eps));
    return rcpp_result_gen;
END_RCPP
}
// get_target
