...
class simplix_orth: public rotation_criterion {
...
class simplix: public rotation_criterion {
...
class rep_simplix_orth: public rotation_criterion {
...
class rep_simplix: public rotation_criterion {
...
class TL: public rotation_criterion {
...
rotation_criterion* choose_between_blocks(std::string rotation) {
