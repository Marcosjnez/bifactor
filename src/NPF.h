...
void f_xtarget(arma::mat& Inv_T, arma::mat& L, arma::mat& Phi, arma::mat& f1, arma::mat& f2, double& f,
  ...
  f = 0.5*(arma::accu(pow(f1, 2)) + w*arma::accu(pow(f2, 2)));
...
void g_xtarget(arma::mat& g, arma::mat f1, arma::mat f2, arma::mat T, arma::mat Inv_T, arma::mat L, arma::mat Weight, arma::mat Phi_Weight, double w) {
  ...
  arma::mat df2_dt = 2 * T * (Phi_Weight % f2);
  
  g = df1_dt + w*df2_dt;
  
}

arma::mat dg_xtarget(arma::mat dT, arma::mat T, arma::mat Inv_T, arma::mat L, arma::mat W2, arma::mat f2, arma::mat PW2, arma::mat g, double w) {
  
  arma::mat Inv_T_dt = Inv_T * dT;
  arma::mat dL = - L * Inv_T_dt.t();
  
  arma::mat dg1L = W2 % dL;
  arma::mat dg2 = 2*dT * f2 + 2*T * (PW2 % (dT.t() * T + T.t() * dT));
...
void tcg_xtarget(arma::mat& dir, bool& att_bnd, arma::mat T, arma::mat Inv_T, arma::mat L, arma::mat g, arma::mat gr, arma::mat W2, arma::mat f2, arma::mat PW2, 
  ...
  do{
    ...
    dg = dg_xtarget(delta, T, Inv_T, L, W2, f2, PW2, g, w);
...
Rcpp::List NPF_xtarget(arma::mat T, arma::mat A, arma::mat Target, arma::mat Weight, arma::mat Phi_Target, arma::mat Phi_Weight, 
  ...
  do{
    ...
    // subsolver
    tcg_xtarget(dir, att_bnd, T, Inv_T, L, g, gr, W2, f2, PW2,  w, ng, c, rad);
